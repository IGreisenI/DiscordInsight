...
namespace Dissonity
{
    ...
    public static class Api {
        ...
        public delegate void GetGuildListDelegate(GuildList data);
        ...
        internal static GetGuildListDelegate _GetGuildListDataEvent;
        ...
        //# JAVASCRIPT PLUGIN - - - - 
            ...
            [DllImport("__Internal")]
            private static extern string RequestGuildList();
        ...
        public static Task<GuildList> GetGuildList()
        {

            var tcs = new TaskCompletionSource<GuildList>();
            ...
            #if UNITY_EDITOR
                // Editor placeholder data
                tcs.TrySetResult(new GuildList { 
                    guilds = new()
                });
            #endif
        ...
        private static void _GetGuildList(GetGuildListDelegate del)
        {

            _GetGuildListDataEvent += del;
